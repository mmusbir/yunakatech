    ...
    <form action={formAction} className="space-y-4">
      <div>
        ...
        <input
          ...
          name="email"
          type="email"
          className="w-full border-[3px] border-black bg-white px-4 py-3 text-sm font-medium outline-none"
      ...
      {error ? (
        <div className="border-[3px] border-red-600 bg-white px-4 py-3 text-xs font-semibold text-red-600">
          {error}
        </div>
      ) : null}
